...
#### TESTING FUNCTION ON GSS 2014

library(foreign)
GSS.14 <- read.spss("GSS2014.sav", to.data.frame = TRUE, trim.factor.names = TRUE,
                         trim_values = TRUE, use.missings = FALSE)

# new variable and frequencies
GSS.14$religion <- rec.relig12(GSS.14$relig, GSS.14$denom, GSS.14$other)